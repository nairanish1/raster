...
# -*- coding: utf-8 -*-
"""
pdf_mask_all.py  –  extract EVERY text string first, then mask every requested
page.

Examples
--------
python pdf_mask_all.py --pdf C:\docs\coordination.pdf --pages all --out build\coord
python pdf_mask_all.py --pdf C:\docs\coordination.pdf --pages 0..3
"""
...
# ───────────── 2. Force UTF-8 for *console output only* ─────────────
...
def dump_json_utf8(path: Path, data) -> None:
    """Guarantee UTF-8 regardless of OS locale."""
